...
class TokenPricingPeriod(TypedDict, total=False):
    ...
    effective_from: str
    effective_until: str
    off_peak_pricing: "OffPeakPricing | None"
...
class OffPeakPricing(TypedDict, total=False):
    ...
    cache_creation_input_token_cost_above_1hr: ReadOnly[float]


class ModelInfoBase(ProviderSpecificModelInfo, total=False):
    pricing_periods: list[TokenPricingPeriod] | None
    pricing_tier_threshold_inclusive: bool | None
    minimum_billable_duration_seconds: float | None
...
class CustomPricingLiteLLMParams(MirroredPricingParams):
    ## CUSTOM PRICING ##
    pricing_periods: list[TokenPricingPeriod] | None = None
    pricing_tier_threshold_inclusive: bool | None = None
    off_peak_pricing: OffPeakPricing | None = None
    minimum_billable_duration_seconds: float | None = None
