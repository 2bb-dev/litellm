...
SPEND_LOG_DB_WRITE_BATCH_SIZE = max(
    1, int(os.getenv("SPEND_LOG_DB_WRITE_BATCH_SIZE", 1000))
)
SPEND_LOG_DB_MAX_LOGS_PER_INTERVAL = max(
    1, int(os.getenv("SPEND_LOG_DB_MAX_LOGS_PER_INTERVAL", 10000))
)
SPEND_LOG_DB_WRITE_TIMEOUT_SECONDS = float(
    os.getenv("SPEND_LOG_DB_WRITE_TIMEOUT_SECONDS", 0)
)
