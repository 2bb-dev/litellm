...
ANTHROPIC_PROMPT_CACHE_OPT_OUT_HEADER: Final = "x-litellm-disable-prompt-cache"
...
SPEND_LOG_DB_WRITE_BATCH_SIZE = max(1, int(os.getenv("SPEND_LOG_DB_WRITE_BATCH_SIZE", 1000)))
SPEND_LOG_DB_WRITE_BATCH_MAX_BYTES = max(1024, int(os.getenv("SPEND_LOG_DB_WRITE_BATCH_MAX_BYTES", 4 * 1024 * 1024)))
SPEND_LOG_DB_WRITE_BATCH_MIN_BYTES = max(
    1024,
    min(
        SPEND_LOG_DB_WRITE_BATCH_MAX_BYTES,
        int(os.getenv("SPEND_LOG_DB_WRITE_BATCH_MIN_BYTES", 64 * 1024)),
    ),
)
SPEND_LOG_DB_MAX_LOGS_PER_INTERVAL = max(1, int(os.getenv("SPEND_LOG_DB_MAX_LOGS_PER_INTERVAL", 10000)))
