...
class TestCooldownCacheExceptionMasking:
    ...
    def test_protected_cooldown_keeps_routing_fields_without_exception_content(self, monkeypatch):
        ...
        written: CooldownCacheValue = cooldown_cache.cooldown_store.get_cache("deployment:model-1:cooldown")
        ...
        assert (
            cooldown_cache.in_memory_cache.ttl_dict["deployment:model-1:cooldown"] - written["timestamp"]
